...
//@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl[user_global_impl]

namespace receiver_comp_Impl
{
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl[user_namespace_impl]
  //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl[user_namespace_impl]
  ...
  shape_data_listener_exec_i::~shape_data_listener_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::shape_data_listener_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::shape_data_listener_exec_i[dtor]
  }
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::shape_data_listener_exec_i::on_many_data[_data_infos]
    X11_UNUSED_ARG(data);
    X11_UNUSED_ARG(infos);
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::shape_data_listener_exec_i::on_many_data[_data_infos]
  }
  /**
  ...
  shape_status_exec_i::~shape_status_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::shape_status_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::shape_status_exec_i[dtor]
  }
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::shape_status_exec_i::on_requested_deadline_missed[_the_reader_status]
    X11_UNUSED_ARG(the_reader);
    X11_UNUSED_ARG(status);
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::shape_status_exec_i::on_requested_deadline_missed[_the_reader_status]
  }
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::shape_status_exec_i::on_sample_lost[_the_reader_status]
    X11_UNUSED_ARG(the_reader);
    X11_UNUSED_ARG(status);
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::shape_status_exec_i::on_sample_lost[_the_reader_status]
  }
  ...
  receiver_comp_exec_i::~receiver_comp_exec_i ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::receiver_comp_exec_i[dtor]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::receiver_comp_exec_i[dtor]
  }
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::receiver_comp_exec_i[configuration_complete]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::receiver_comp_exec_i[configuration_complete]
  }
  ...
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::receiver_comp_exec_i[ccm_passivate]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::receiver_comp_exec_i[ccm_passivate]
  }

  void receiver_comp_exec_i::ccm_remove ()
  {
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::receiver_comp_exec_i[ccm_remove]
    // Your code here
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::receiver_comp_exec_i[ccm_remove]
  }
  ...
  receiver_comp_exec_i::get_shape_data_listener ()
  {
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::receiver_comp_exec_i[get_shape_data_listener]
  ...
  //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::receiver_comp_exec_i[get_shape_data_listener]
  }



  IDL::traits< ::CCM_DDS::CCM_PortStatusListener >::ref_type
  receiver_comp_exec_i::get_shape_status ()
  {
  //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::receiver_comp_exec_i[get_shape_status]
    if (!this->shape_status_)
    {
      this->shape_status_ = CORBA::make_reference <shape_status_exec_i> (this->context_);
    }
    return this->shape_status_;
  //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::receiver_comp_exec_i[get_shape_status]
  }
    ...
    IDL::traits<Components::SessionContext>::ref_type ctx)
  {
    ...
    //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl::receiver_comp_exec_i[set_session_context]
    this->context_ = IDL::traits< CCM_receiver_comp_Context >::narrow (ctx);
    //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl::receiver_comp_exec_i[set_session_context]
  }


  //@@{__RIDL_REGEN_MARKER__} - BEGIN : receiver_comp_Impl[user_namespace_end_impl]
  //@@{__RIDL_REGEN_MARKER__} - END : receiver_comp_Impl[user_namespace_end_impl]
